# EXtendedTETRIckS - A Highly Customizable Tetris Game Programming Language

**EXtendedTETRIckS** is a Tetris game programming language that offers a wide range of customization options, allowing users to tailor the game experience to their preferences. This README provides a detailed overview of the customizable features and explains the input format for the configuration file.
...
- [Features](#features)
  ...
  - [Movement Offsets](#movement-offsets)
  - [Difficulty Levels](#difficulty-levels)
  - [Custom Extetromino Range](#custom-extetromino-range)
  - [Frequency Distribution](#frequency-distribution)
  - [Rotate Limit](#rotate-limit)
  - [End Game Message](#end-game-message)
  - [Maximum Level](#maximum-level)
- [Extetromino Distribution](#extetromino-distribution)
...
- Run `make test_no_bython` if the input code does not contain any functions, loops, or if statements. This can also be used if there is some difficulty installing or working with the bython library.
...
The input format allows you to customize various aspects of the game, including the game title, theme, board size, cursor position, key bindings, movement offsets, difficulty levels, extetromino range, frequency distribution, rotate limit, end game message, and more. If some of the aspects are not defined, default values are used allowing even more ease of use.
...
theme = "hecker" # sets the theme(background colour, foreground colour, font), choose from the list of theme's provided in themes.py or choose to set a custom theme and specify bg and fg
